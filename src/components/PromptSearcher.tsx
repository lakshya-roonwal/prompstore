...
const PromptSearcher = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-start w-full min-h-screen py-16 lg:py-32 bg-background">
        ...
        <div className="space-y-4">
          {prompts.map((prompt) => (
            ...
            >
              ...
              <Link href={prompt.link} className={buttonVariants()}>View</Link>
            </div>
          ))}
        </div>
      </div>
